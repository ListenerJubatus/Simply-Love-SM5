...
local t = Def.ActorFrame {
	...
	LoadFont("Common Normal") .. {
		...
		InitCommand=cmd(x,-80;maxwidth,32;zoom,0.75),
		OnCommand=cmd(diffuse,ColorLightTone(PlayerColor(PlayerNumber));diffusealpha,0;smooth,0.3;diffusealpha,1;),
		OffCommand=cmd(smooth,0.2;diffusealpha,0)
	},
	LoadFont("Common Normal") .. {
		Text=bpm_text;
		Name="BPMRangeOld",
		InitCommand=cmd(x,-35;maxwidth,88/bpm_text_zoom),
		OnCommand=cmd(zoom,bpm_text_zoom;diffusealpha,0;smooth,0.3;diffusealpha,1;),
		OffCommand=cmd(smooth,0.2;diffusealpha,0)
	},
	LoadActor(THEME:GetPathG("EditMenu","Right")) .. {
		Name="Seperator",
		InitCommand=cmd(x,5;zoom,0.5;);
	...
	LoadFont("Common Normal") .. {
		...
		InitCommand= function(self)
			self:x(48):maxwidth(88/bpm_text_zoom):zoom(bpm_text_zoom)
